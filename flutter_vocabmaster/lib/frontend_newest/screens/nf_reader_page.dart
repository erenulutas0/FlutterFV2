...
// The tapped-word sheet that used to live here is now
// `NfWordSheet` in ../widgets/nf_word_lookup.dart. It moved because the first
// piece of feedback this app ever had asked for the same tap in the tutor's
// chat, and the version written for books was already the entire answer.
